...
ts.
REMEMBER TO create visualizations of this data to support your insights.
...
REPORT_PROMPT = """
        ...
        Include <IMAGE="image.png"/> tokens to indicate where images should be placed in the report. This is neccesary.
        Each image token must have a corresponding description. Provide a description for each visualization generated.
        Focus on specificity and depth without summarizing or using bullet points. Make sure images are included in the middle of the report content
        and not in the end. 
